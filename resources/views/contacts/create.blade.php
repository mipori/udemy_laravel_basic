                                    ...
                                    <div class="flex flex-wrap -m-2">
                                        ...
                                        <div class="p-2 w-full">
                                            <div class="relative">
                                                ...
                                                <input type="radio" name="gender" value="0" {{ old('gender') == 0 ? 'checked' : '' }} class="mr-2 h-4 w-4 border-gray-300 text-indigo-600 focus:ring-indigo-600">男性　
                                                <input type="radio" name="gender" value="1" {{ old('gender') == 1 ? 'checked' : '' }} class="mr-2 h-4 w-4 border-gray-300 text-indigo-600 focus:ring-indigo-600">女性
                                            </div>
                                        </div>
                                        <div class="p-2 w-full">
                                            <div class="relative">
                                                <label for="age" class="leading-7 text-sm text-gray-600">年齢</label>
                                                <select name="age"class="block appearance-none bg-white border border-gray-300 hover:border-gray-500 px-4 py-2 pr-8 rounded shadow leading-tight focus:outline-none focus:shadow-outline">
                                        ...
                                        <div class="p-2 w-full">
                                            <div class="relative">
                                                ...
                                                <textarea id="contact" name="contact" value="{{ old('contact') }}"  class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 h-32 text-base outline-none text-gray-700 py-1 px-3 resize-none leading-6 transition-colors duration-200 ease-in-out"></textarea>
                                            </div>
                                        </div>
                                        <div class="p-2 w-full">
                                            <div class="relative">
                                                <input type="checkbox" id="caution" name="caution" class="mr-2 h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-600">
                                                注意事項に同意する
                                            </div>
                                        </div>
                                        <div class="p-2 w-full">
