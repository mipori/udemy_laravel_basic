                                    ...
                                    <div class="flex flex-wrap -m-2">
                                        ...
                                        <div class="p-2 w-full">
                                            <div class="relative">
                                                ...
                                                <input type="radio" name="gender" value="0" class="mr-2 h-4 w-4 border-gray-300 text-indigo-600 focus:ring-indigo-600" @if($contact->gender === 0) checked @endif>男性　
                                                <input type="radio" name="gender" value="1" class="mr-2 h-4 w-4 border-gray-300 text-indigo-600 focus:ring-indigo-600" @if($contact->gender === 1) checked @endif>女性
                                            </div>
                                        </div>
                                        <div class="p-2 w-full">
                                            <div class="relative">
